...
namespace PCPanelController {
    static class SendInputHelper {
        public static void SimulateKey(ScanCodeShort key) {
            INPUT[] Inputs = new INPUT[2];
            INPUT Input = new INPUT();

            Input.type = 1;
            Input.U.ki.wScan = key;
            Input.U.ki.dwFlags = KEYEVENTF.SCANCODE | KEYEVENTF.EXTENDEDKEY;
            Inputs[0] = Input;

            Input.type = 1;
            Input.U.ki.wScan = key;
            Input.U.ki.dwFlags = KEYEVENTF.SCANCODE | KEYEVENTF.EXTENDEDKEY | KEYEVENTF.KEYUP;
            Inputs[1] = Input;
